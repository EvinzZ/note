...
[GitHub - Python3WebSpider/ProxyPool: An Efficient ProxyPool with Getter, Tester and Server](https://github.com/Python3WebSpider/ProxyPool)

# ProxyPool

![build](../images/badge.svg)

![deploy](../images/badge.svg)

![img](../images/python-3.6+-brightgreen)

![Docker Pulls](../images/proxypool)
...
可以看到成功获取了代理，并请求 [httpbin.org](http://httpbin.org) 验证了代理的可用性。
